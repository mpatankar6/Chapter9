...
public class AccountTester {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Special bankaccount.Account " + sca1.currentBalance());
        ...
        System.out.println("Special bankaccount.Account " + sca2.currentBalance());
        ...
        for(Account a: accounts){
            System.out.println("bankaccount.Account " + a.idNumber());
